 ...
 **Output**: It will create df_american_movies_post1969.csv file that contains the data for supervised learning.

3. Run Supervised Learning.ipynb.
...
4. TreePloy.ipynb
   **Output:** It will create a tree plot for the user inputs using LinearSVC model. 
5. Unsupervised learning files
6. ClusterPlot.ipynb. It will create cluster plot. 
